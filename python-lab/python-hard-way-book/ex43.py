...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            print(dedent("""
                Quick on draw you yank out your blaster and fire it at the Gothom.
                ...
                which makes him fly into insane rage and blast you repeatedly in 
                the face until you are dead. The he eats you.
            """))
            ...
            print(dedent("""
                ...
                dodge your foots slips and you bang your head on the metal wall and pass out.
                You make up shortly after only to die as the Gothon stomps on your head and eats you.
            """))
            ...
            print(dedent("""
                ...
                Gothon joke you know: Lbhe zbgure vf fb sng, jura fur fvfg nebhaq gur ubhfr fur
                fgfv nebhaq gur ubhfr. The Gothon stops, tries not to laugh, then busts out laughing
                you run up and shoot him square in the head putting him down, then jump thorough the
                Weapon Armory door.
            """))
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            to the far side of the romm and find the neutron bomb in its container.
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print(dedent("""
                ...
                You inch backward to the door, open it, and then carefully place
                the bomb on the floor, pointing your blaster at it. You then jump
                back through the door, punch the close button and blast the lock
                so the Gothons can't get out. Now that them bomb is placed you
                run to the scape pod to get off this tin can.
            """))
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
            You rush through the ship desperatelly trying to make it to the escape
            pod before the whole ship explodes. It seems like hardly any Gothons are 
            on the ship, so your run is clear of interference. You get to the chamber with
            the escape pods, and now need topick one to take. Some of them could be damaged
